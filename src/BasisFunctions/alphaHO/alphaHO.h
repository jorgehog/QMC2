...
public:
    ...
    dell_alphaHO_0_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_0_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_0(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_1_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_1_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_1(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_2_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_2_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_2(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_3_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_3_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_3(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_4_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_4_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_4(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_5_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_5_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_5(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_6_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_6_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_6(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_7_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_7_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_7(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_8_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_8_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_8(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_9_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_9_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_9(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_10_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_10_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_10(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_11_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_11_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_11(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_12_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_12_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_12(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_13_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_13_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_13(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_14_x(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    dell_alphaHO_14_y(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
...
public:
    ...
    lapl_alphaHO_14(double* k, double* k2);
    virtual double eval(const Walker* walker, int i) const;
